...
if selected == "Info":
    ...
    st.info("""
        ...
        Sentence 1.age - age in years
        Sentence 2.sex - (1 = male; 0 = female)
        Sentence 3.cp - chest pain type
    * 0: Typical angina: chest pain related decrease blood supply to the heart
    * 1: Atypical angina: chest pain not related to heart
    * 2: Non-anginal pain: typically esophageal spasms (non heart related)
    * 3: Asymptomatic: chest pain not showing signs of disease        
        Sentence 4.trestbps - resting blood pressure (in mm Hg on admission to the hospital) anything above 130-140 is typically cause for concern
        Sentence 5.chol - serum cholestoral in mg/dl
    * serum = LDL + HDL + .2 * triglycerides
    * above 200 is cause for concern        
        Sentence 6. fbs - (fasting blood sugar > 120 mg/dl) (1 = true; 0 = false)
    * '>126' mg/dL signals diabetes        
        Sentence 7.restecg - resting electrocardiographic results
    * 0: Nothing to note
    ...
    * 2: Downslopins: signs of unhealthy heart
        Sentence 12.ca - number of major vessels (0-3) colored by flourosopy
    * colored vessel means the doctor can see the blood passing through
    * the more blood movement the better (no clots)
    Sentence 13.thal - thalium stress result
    * 1,3: normal
